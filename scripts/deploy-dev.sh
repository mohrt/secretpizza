...
DIST_ID=$(cd terraform && terraform output -raw dev_cloudfront_distribution_id)
BUCKET=$(cd terraform && terraform output -raw dev_s3_bucket_name)
...
echo "🌐 Dev site: https://dev.secretpizza.org"
